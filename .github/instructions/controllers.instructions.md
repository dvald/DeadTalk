---
applyTo: "src/controllers/api/**/*.ts,src/controllers/**/*.ts,**/controllers/api/**/*.ts,controllers/**/*.ts"
---

# Copilot Instructions — Controllers (Swagger-driven API bindings)
...
## 10) Copilot prompt (for this folder)
