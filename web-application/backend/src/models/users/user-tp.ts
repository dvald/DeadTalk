...
import { DataModel, DataSource, DataFinder, TypedRow } from "tsbean-orm";
...
export class ThirdPartyUser extends DataModel {
    ...
    public static async create(service: string, id: string, email: string, name: string, profileName?: string): Promise<ThirdPartyUser> {
