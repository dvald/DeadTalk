...
| `SMTP_DKIM_ENABLED`            | Can be `YES` or `NO`. Set it to `YES` to enable DKIM.                             |
| `SMTP_DKIM_DOMAIN`             | Domain for DKIM.                                                                  |
| `SMTP_DKIM_KEY_SELECTOR`       | Key selector for DKIM.                                                            |
| `SMTP_DKIM_PRIVATE_KEY`        | Path to the private key file (PEM format) for DKIM.                               |
