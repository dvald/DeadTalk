...
import type { RequestParams, CommonAuthenticatedErrorHandler } from "@asanrom/request-axios";
import { getApiUrl, generateURIQuery } from "./utils";
import type { UserAdminList, UserAdminDetails, AdminSetRoleBody, UserAdminEmailChange, UserAdminUsernameChange, UserAdminPasswordChange } from "./definitions";
...
export class ApiUsersAdmin {
    ...
    public static GetUsers(queryParams: GetUsersQueryParameters): RequestParams<UserAdminList, GetUsersErrorHandler> {
        return {
            method: "GET",
            url: getApiUrl(`/admin/users` + generateURIQuery(queryParams)),
    ...
    public static GetUser(id: string): RequestParams<UserAdminDetails, GetUserErrorHandler> {
        return {
            method: "GET",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}`),
            handleError: (err, handler) => {
                new RequestErrorHandler()
    ...
    public static SetRole(id: string, body: AdminSetRoleBody): RequestParams<void, SetRoleErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/role`),
            json: body,
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
    ...
    public static Ban(id: string): RequestParams<void, BanErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/ban`),
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
                    .add(403, "*", handler.forbidden)
    ...
    public static Pardon(id: string): RequestParams<void, PardonErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/pardon`),
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
                    .add(403, "*", handler.forbidden)
    ...
    public static DisableTFA(id: string): RequestParams<void, DisableTFAErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/tfa/disable`),
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
                    .add(403, "*", handler.forbidden)
     ...
     * @returns The request parameters
     */
    public static ChangeEmailFromAdmin(id: string, body: UserAdminEmailChange): RequestParams<void, ChangeEmailFromAdminErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/email`),
            json: body,
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
     ...
     * @returns The request parameters
     */
    public static ChangeUsernameFromAdmin(id: string, body: UserAdminUsernameChange): RequestParams<void, ChangeUsernameFromAdminErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/username`),
            json: body,
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
     ...
     * @returns The request parameters
     */
    public static ChangePasswordFromAdmin(id: string, body: UserAdminPasswordChange): RequestParams<void, ChangePasswordFromAdminErrorHandler> {
        return {
            method: "POST",
            url: getApiUrl(`/admin/users/${encodeURIComponent(id)}/password`),
            json: body,
            handleError: (err, handler) => {
                new RequestErrorHandler()
                    .add(404, "*", handler.notFound)
...
/**
 * Error handler for ChangeEmailFromAdmin
 */
export type ChangeEmailFromAdminErrorHandler = CommonAuthenticatedErrorHandler & {
    /**
     * General handler for status = 400
     */
    badRequest: () => void;
...
/**
 * Error handler for ChangeUsernameFromAdmin
 */
export type ChangeUsernameFromAdminErrorHandler = CommonAuthenticatedErrorHandler & {
    /**
     * General handler for status = 400
     */
    badRequest: () => void;
...
/**
 * Error handler for ChangePasswordFromAdmin
 */
export type ChangePasswordFromAdminErrorHandler = CommonAuthenticatedErrorHandler & {
    /**
     * General handler for status = 400
     */
    badRequest: () => void;
