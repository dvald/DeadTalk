...
The smart contracts are compiled and deployed using the [Solidity Compiler](https://github.com/ethereum/solidity) and deployed / tested using the [Smart contract wrapper](https://github.com/AgustinSRG/smart-contract-wrapper) library.
